...
static PyMethodDef UtilsFcts[] = {
  ...
  { (char*) "calc_ftest", (PyCFunction) ftest, METH_VARARGS,
    (char*) "calc_ftest(dof1, stat1, dof2, stat2)\n\n"
            ...
            "   distribution.\n\n"
            "See Protassov et al. 2002 [Protassov]_ for more discussion.\n"
            REFERENCESDOC "\n"
            ".. [Protassov] Protassov et al., Statistics, Handle with Care: Detecting\n"
  ...
  { (char*) "igamc", (PyCFunction) igamc, METH_VARARGS,
    (char*) "igamc(a,x)\n\n"
            ...
            "Library [Cephes]_, both arguments must be positive. The integral is\n"
            ...
            "========  ======  ========  =======  =======\n"
            REFERENCESDOC "\n"
            ".. [Cephes] Cephes Math Library Release 2.0:  April, 1987.\n"
  ...
  { (char*) "incbet", (PyCFunction) incbet, METH_VARARGS,
    (char*) "incbet(a,b,x)\n\n"
            ...
            NOTESDOC
            "In this implementation, which is provided by the Cephes Math\n"
            "Library [Cephes]_, the integral is evaluated by a continued fraction\n"
  ...
  { (char*) "gamma", (PyCFunction) gamma, METH_VARARGS,
    (char*) "gamma(z)\n\n"
            ...
            NOTESDOC
            "This implementation is provided by the Cephes Math Library [Cephes]_.\n"
